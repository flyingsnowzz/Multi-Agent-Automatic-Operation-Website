...
class TestTopicCandidateIntegration(unittest.TestCase):
    ...
    def test_workflow_e2e_accepted_rewrite_candidate(self, mock_read, mock_update, mock_pg):
        ...
        self.assertEqual(second_call_args[0][1]["agent_name"], "WriterAgent")
        self.assertEqual(second_call_args[0][1]["task_type"], "rewrite")
        self.assertEqual(second_call_args[0][1]["input_data"]["workflow_route"], "full_rewrite_flow")
